...
<html
  ...
  data-assets-path="{{ URL::asset('assets/')}}"
...
>
  <head>
    ...
    <title>SIPW | Sistem Informasi Pembayaran Wifi</title>
    ...
    <link rel="stylesheet" href="{{ URL::asset('assets/vendor/fonts/boxicons/boxicons.ttf')}}" />
    <link rel="stylesheet" href="{{ URL::asset('assets/vendor/fonts/boxicons/boxicons.woff')}}" />
    <link rel="stylesheet" href="{{ URL::asset('assets/vendor/fonts/boxicons/boxicons.woff2')}}" />
